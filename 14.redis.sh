...
sadd likes:posting:1 abc@naver.com #좋아요를 눌느 경우
srem likes:psoting:1 abc@naver.com # 좋아요 취소
# zset자료구조 : sorted set
# zset활용 사례1 : 최근 본 상품목록
...
# 빈번하게 변경되는 객체값을 저장시에는 hashes가 성능 효율적이다